...
const Hindi_Form = () => {
    ...
    useEffect(() => {
        ...
        const storedName = localStorage.getItem('userName'); // Adjust the key based on your implementation
        if (storedName) {
    ...
    const handleSubmit = (e) => {
        ...
        navigate('/session', {
            state: {
                characterId: 'ac20a0a0-70e5-11ef-8637-42010a7be011',
                companyName,
                jobRole,
                // timeDuration,
                noOfQuestions,
                ...
                <div className="container1">
                    <div className="my-form">
                        ...
                        <div className="form-title">
                            {userName && <h2>नमस्ते, {userName}!</h2>} {/* Display user's name if available */}
                        </div>
